        ...
        >
          <div className="overflow-hidden px-4 py-8">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Decorative background blur circle - hidden on mobile for performance, optimized on desktop */}
                <div className="hidden md:block absolute top-0 end-0 -m-8 h-32 w-32 sm:h-40 sm:w-40 rounded-full bg-primary/5 blur-3xl transition-all duration-300 group-hover:bg-primary/10"></div>
