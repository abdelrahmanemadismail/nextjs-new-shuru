...
export async function SiteFooter({ locale }: SiteFooterProps) {
  ...
  return (
    <footer className="w-full relative overflow-hidden bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800/50 pt-12 pb-[calc(3rem+env(safe-area-inset-bottom))] sm:py-16 px-4 sm:px-6">
      {/* Subtle top glow */}
